...
import smilelandtitle from "../../assets/image/smilelandtitle.png";
...
const Smileland = () => {
    ...
    const onVisit = () => {
        window.open('https://sweb.netlify.app/');
    }

    const onGithub = () => {
        window.open('https://github.com/yohanbae/sweb');
    }

    return(
        <Wrap>
            <Img src={smilelandtitle} />
            <div>
            <H3>SMILE LAND</H3>
