...
import promisetitle from "../../assets/image/promisetitle.png";
...
const Promise = () => {
    ...
    const onVisit = () => {
        window.open('https://promisehani.netlify.app/');
    }
    ...
    const onGithub = () => {
        window.open('https://github.com/yohanbae/reactpromise');
    }

    const onGithubMobile = () => {
        window.open('https://github.com/yohanbae/promise_mobile');
    }

    return(
        <Wrap>
            <Img src={promisetitle} />
            <div>
            <H3>PROMISE</H3>
            ...
            <DescWrap>
                <HLink onClick={() => onVisit()}>VISIT WEBSITE</HLink>
                <HLink onClick={() => onGithub()}>GITHUB</HLink>
                <HLink onClick={() => onDownload()}>DOWNLOAD MOBILE APK</HLink>
                <HLink onClick={() => onGithubMobile()}>MOBILE GITHUB</HLink>
            </DescWrap>    
            </div>
        </Wrap>
